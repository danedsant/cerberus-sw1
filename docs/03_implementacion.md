...
| **HU-05** | 2 | Login de Usuarios | **Como** usuario,<br>**Quiero** iniciar sesión con mis credenciales y una transición visual con el logo de la app,<br>**Para** acceder a funciones de mi rol con una experiencia más fluida y consistente. | **Given** la página de login<br>**When** ingreso datos válidos<br>**Then** se activa la transición visual con el logo y soy redirigido a mi dashboard |
...
| HU-21 | Historial Personal del Vigilante | ✅ |
...
**Avance total:** 19/21 HU completadas (90%)
