...
| **HU-05** | 2 | Login de Usuarios | **Como** usuario,<br>**Quiero** iniciar sesión con mis credenciales y una transición visual con el logo de la app,<br>**Para** acceder a funciones de mi rol con una experiencia más fluida. | **Given** la página de login<br>**When** ingreso datos válidos<br>**Then** se activa la transición visual con el logo y soy redirigido a mi dashboard |
| **HU-22** | 3 | Transición de Login con Branding | **Como** usuario,<br>**Quiero** ver una transición visual con el logo de la aplicación al iniciar sesión,<br>**Para** viajar de forma natural desde el login hasta mi dashboard sin romper la experiencia visual. | **Given** la página de login disponible<br>**When** ingreso credenciales válidas y el sistema autentica al usuario<br>**Then** se muestra una transición con el logo y luego se redirige al dashboard correspondiente |
...
| **HU-21** | 2 | Historial Personal del Vigilante | **Como** Vigilante,<br>**Quiero** consultar mi propio historial de ingresos validados,<br>**Para** auditar mi actividad en portería. | **Given** sesión como vigilante<br>**When** navego a Historial<br>**Then** veo solo los ingresos que yo he validado con filtros por fecha |
...
| US-021 | Historial Personal del Vigilante | Media | ✅ Completado |
